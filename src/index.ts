...
fieldDecoratorKit.setDomainList(['dify.newki.com', 'api.dify.ai', 'cloud.dify.ai','ai.fillwant.com', '192.168.4.51', 'alibaba-inc.com', 'aip.ciwork.cn', 'erp.amz-marketing.com', '115.190.241.165', 'dify.mobvista.com', 'wmaterials.newbanker.cn', 'dify.newbanker.cn', 'sirioai-api.siriopharma.com', 'ai.htvaluer.com']);
...
fieldDecoratorKit.setDecorator({
  ...
  execute: async (
    ...
    try {
      // 验证 API URL 是否符合要求
      const allowedDomains = ['dify.newki.com', 'api.dify.ai', 'cloud.dify.ai', 'ai.fillwant.com',  'alibaba-inc.com', 'aip.ciwork.cn', 'erp.amz-marketing.com', '115.190.241.165', 'dify.mobvista.com', '192.168.4.51', 'wmaterials.newbanker.cn', 'dify.newbanker.cn', 'sirioai-api.siriopharma.com', 'ai.htvaluer.com'];
